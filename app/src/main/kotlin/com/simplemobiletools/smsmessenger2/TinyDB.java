package com.simplemobiletools.smsmessenger2;
...
import com.simplemobiletools.smsmessenger2.models.ThreadItem;
...
//    }
    ...
    public void putListThreadItem(String key, ArrayList<ThreadItem> stringList) {
        checkForNullKey(key);
        ThreadItem[] myStringList = stringList.toArray(new ThreadItem[stringList.size()]);
        preferences.edit().putString(key, TextUtils.join("‚‗‚", myStringList)).apply();
    }
